;;; Тесты для Scheme.
;;;
;;; Для того, чтобы выполнялась только часть этого файла
;;; вставляй строку
;;;
;;; (exit)
;;;
;;; после последнего необходимого теста.

;;; ********************************
;;; *** Добавь свои тесты здесь! ***
;;; ********************************

;;; Ниже приведены примеры из книги
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; Для выполнения других тестов перемести (exit). ;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(define square (lambda (x) (* x x))) ; Смотри раздел 1.3.2
(square 21)
; expect 441
...
;;; Тесты Питера Норвига (http://norvig.com/lispy2.html)

(define double (lambda (x) (* 2 x)))
(double 5)
; expect 10

(define compose (lambda (f g) (lambda (x) (f (g x)))))                                     ;AAAAAAAAAAAAAAAAAA
...
; Тесты на оптимизацию хвостовой рекурсии
